...
|
*/
$config['base_url'] = 'https://lsbizportal.lemonsquare.com.ph/k-net/';
// $config['base_url'] = 'http://209.141.3.238/test/';
...
$config['kflow_base_url']    = 'https://lsbizportal.lemonsquare.com.ph/k-flow-test/';     // K-flow base URL
