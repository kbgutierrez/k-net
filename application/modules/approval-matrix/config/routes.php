...
$route['maintenance/approval-matrix/api/get/sales-offices'] = 'Approval_Matrix/api_get_sales_offices';
$route['maintenance/approval-matrix/api/get/sales-districts'] = 'Approval_Matrix/api_get_sales_districts';
$route['maintenance/approval-matrix/api/save'] = 'Approval_Matrix/api_save';
$route['maintenance/approval-matrix/api/update'] = 'Approval_Matrix/api_update';  // <-- ADD THIS
