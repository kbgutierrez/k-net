...
<div class="page-inner kna-page">
	<input type="hidden" id="matrixId" value="<?=(int) $matrix_id;?>">

	<div class="d-flex align-items-center justify-content-between mb-2 kna-stack-mobile">
		<div>
			<div class="kna-title">Edit Approval Matrix</div>
		</div>
		<div class="d-flex" style="gap:.45rem;">
			...
			<button type="button" class="btn btn-primary btn-sm kna-small" id="btnSaveMatrix">Save Changes</button>
		</div>
	</div>
		...
		<div class="card-body">
			...
			<div class="form-row">
				...
				<div class="form-group col-md-3">
					...
					<select class="form-control form-control-sm kna-small" id="isActive">
