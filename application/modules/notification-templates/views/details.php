...
<div class="page-inner kna-page">
	<input type="hidden" id="templateId" value="<?=(int)$template_id;?>">

	<div class="d-flex align-items-center justify-content-between mb-2">
		<div>
			<div class="kna-title">Edit Notification Template</div>
		...
		<div class="d-flex align-items-center" style="gap:.6rem;">
			<div class="custom-control custom-switch">
				<input type="checkbox" class="custom-control-input" id="templateIsActive" checked>
				<label class="custom-control-label kna-small" for="templateIsActive">Active</label>
			</div>
		...
		<div class="card-body">
			<div class="kna-step-head mb-0">
				...
				<div>
					...
					<div class="kna-step-hint">Use Preview to see the email with sample data filled in before saving. Turn off "Active" above to stop this template from being used without deleting it.</div>
				</div>
			</div>
		</div>
	</div>
