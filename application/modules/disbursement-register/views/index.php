...
<div class="page-inner kna-page">
	<div class="d-flex align-items-center justify-content-between mb-2 kna-stack-mobile">
		<div>
			<div class="kna-title">Disbursement Register</div>
		</div>
	...
	<div class="row mb-2">
		<div class="col-md-3 col-6 pr-md-2 mb-2 mb-md-0">
			<div class="card kna-card h-100">
				<div class="card-body">
					<p class="kna-kpi-caption">Total Disbursements</p>
		...
		<div class="col-md-3 col-6 pr-md-2 pl-md-2 mb-2 mb-md-0">
			<div class="card kna-card h-100">
				<div class="card-body">
					<p class="kna-kpi-caption">Distinct Requesters</p>
					<p class="kna-kpi" id="sumRequesters">0</p>
				</div>
			</div>
		</div>
		<div class="col-md-3 col-6 pl-md-2">
			<div class="card kna-card h-100">
				<div class="card-body">
					<p class="kna-kpi-caption">This Month</p>
					<p class="kna-kpi" id="sumThisMonth">0.00</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="card-body py-2">
			<div class="d-flex flex-wrap align-items-end" style="gap:.5rem;">
				<div>
					...
					<input type="text" class="form-control form-control-sm kna-small" id="filterKeyword" placeholder="Reference no., requester, released by" style="width:240px;">
				</div>
				<div>
	...
	<div class="card kna-card d-none d-md-block">
		<div class="card-body">
			<div class="d-flex align-items-center justify-content-between mb-2">
				<div class="kna-small text-muted">Disbursement Register</div>
				...
				<table class="table table-sm kna-table" id="registerTable" style="width:100%">
					<thead>
						<tr>
							...
							<th style="width:150px;">Released By</th>
			...
			<div class="d-flex justify-content-end mt-2">
				<nav aria-label="Disbursement register desktop pagination">
