...
<div class="page-inner kna-page">
	<div class="d-flex align-items-center justify-content-between mb-2 kna-stack-mobile">
		<div>
			<div class="kna-title">Cost Center Utilization Report</div>
		</div>
	...
	<div class="row mb-2">
		<div class="col-md-3 col-6 pr-md-2 mb-2 mb-md-0">
			<div class="card kna-card h-100">
				<div class="card-body">
					<p class="kna-kpi-caption">Total Utilization</p>
		...
		<div class="card-body py-2">
			<div class="d-flex flex-wrap align-items-end" style="gap:.5rem;">
				...
				<div>
					...
					<select class="form-control form-control-sm kna-small" id="filterType" style="width:150px;">
	...
	<div class="card kna-card d-none d-md-block">
		<div class="card-body">
			<div class="d-flex align-items-center justify-content-between mb-2">
				<div class="kna-small text-muted">Transactions</div>
			...
			<div class="d-flex justify-content-end mt-2">
				<nav aria-label="Utilization desktop pagination">
	...
	<div class="card kna-card d-md-none">
		<div class="card-body">
			...
			<div class="kna-mobile-list" id="utilizationMobileList"></div>
